...
let to_error_data = function
  ...
  | `Invalid_request msg ->
    { code = invalid_request; message = msg; data = None }
  | `Method_not_found msg ->
    { code = method_not_found; message = msg; data = None }
  | `Invalid_params msg -> { code = invalid_params; message = msg; data = None }
  | `Internal_error msg -> { code = internal_error; message = msg; data = None }
  | `Connection_closed msg ->
    { code = connection_closed; message = msg; data = None }
