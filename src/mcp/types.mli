...
type any_function =
  unit -> unit (* A placeholder, as the original is very generic *)
...
type 'params request = { method_ : string; [@key "method"] params : 'params }
[@@deriving compare, sexp]
...
type jsonrpc_error = { jsonrpc : string; id : request_id; error : error_data }
[@@deriving compare, sexp]
...
type subscribe_request = subscribe_request_params request
[@@deriving compare, sexp]
...
type unsubscribe_request = unsubscribe_request_params request
[@@deriving compare, sexp]
...
type resource_updated_notification =
  resource_updated_notification_params notification
[@@deriving compare, sexp]

(* Prompts *)
type list_prompts_request = paginated_request_params paginated_request
[@@deriving compare, sexp]
...
type get_prompt_request = get_prompt_request_params request
[@@deriving compare, sexp]
...
type resource_link = {
  ...
  resource : resource;
      [@to_yojson resource_to_yojson] [@of_yojson resource_of_yojson]
}
[@@deriving compare, sexp]
...
type prompt_message = { role : role; content : content_block }
[@@deriving compare, sexp]
...
(* Tools *)
type list_tools_request = paginated_request_params paginated_request
[@@deriving compare, sexp]

type tool_annotations = {
  title : string option; [@default None] [@yojson.option]
  read_only_hint : bool option;
      [@key "readOnlyHint"] [@default None] [@yojson.option]
  destructive_hint : bool option;
      [@key "destructiveHint"] [@default None] [@yojson.option]
  idempotent_hint : bool option;
      [@key "idempotentHint"] [@default None] [@yojson.option]
  open_world_hint : bool option;
      [@key "openWorldHint"] [@default None] [@yojson.option]
}
[@@deriving compare, sexp]
...
type call_tool_request = call_tool_request_params request
[@@deriving compare, sexp]
...
type set_level_request = set_level_request_params request
[@@deriving compare, sexp]
...
type logging_message_notification =
  logging_message_notification_params notification
[@@deriving compare, sexp]
...
type model_hint = { name : string option [@default None] [@yojson.option] }
[@@deriving compare, sexp]

type model_preferences = {
  hints : model_hint list option; [@default None] [@yojson.option]
  cost_priority : float option;
      [@key "costPriority"] [@default None] [@yojson.option]
  speed_priority : float option;
      [@key "speedPriority"] [@default None] [@yojson.option]
  intelligence_priority : float option;
      [@key "intelligencePriority"] [@default None] [@yojson.option]
}
[@@deriving compare, sexp]
...
type create_message_request_params = {
  ...
  model_preferences : model_preferences option;
      [@key "modelPreferences"] [@default None] [@yojson.option]
  system_prompt : string option;
      [@key "systemPrompt"] [@default None] [@yojson.option]
  include_context : include_context option;
      [@key "includeContext"] [@default None] [@yojson.option]
  temperature : float option; [@default None] [@yojson.option]
  max_tokens : int; [@key "maxTokens"]
  stop_sequences : string list option;
      [@key "stopSequences"] [@default None] [@yojson.option]
...
type create_message_request = create_message_request_params request
[@@deriving compare, sexp]

type stop_reason = [ `EndTurn | `StopSequence | `MaxTokens | `String of string ]
[@@deriving compare, sexp]
...
type create_message_result = {
  ...
  stop_reason : stop_reason option;
      [@key "stopReason"] [@default None] [@yojson.option]
  result : result; [@to_yojson result_to_yojson] [@of_yojson result_of_yojson]
}
[@@deriving compare, sexp]
...
type roots_list_changed_notification = Notification_params.t option notification
[@@deriving compare, sexp]
...
type cancelled_notification = cancelled_notification_params notification
[@@deriving compare, sexp]
