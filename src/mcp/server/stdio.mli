(** Stdio Server Transport Module
    ...
    This module provides functionality for creating an stdio-based transport
    layer that can be used to communicate with an MCP client through standard
...
(** Run a function with a stdio server, providing read and write streams. The
    server will be automatically cleaned up when the function completes. *)
