...
module TestData = struct
  let complex_schema =
    `Assoc
      [
        ...
        ( "info",
          `Assoc
            [ ("title", `String "Complex API"); ("version", `String "1.0.0") ]
        );
        ( "paths",
          `Assoc
            [
                            ...
                            `List
                              [
                                `Assoc
                                  [
                                    ( "$ref",
                                      `String "#/components/parameters/UserId"
                                    );
                                  ];
                                `Assoc
                                  [
                                    ( "$ref",
                                      `String
                                        "#/components/parameters/IncludeInactive"
                                    );
                                  ];
                              ] );
                          ( "responses",
                          ...
                          ( "requestBody",
                            `Assoc
                              [
                                ( "$ref",
                                  `String
                                    "#/components/requestBodies/OrderRequest" );
                              ] );
                          ( "responses",
                            `Assoc
                              [
                                ( "201",
                                  `Assoc
                                    [ ("description", `String "Order created") ]
                                );
                              ] );
                        ] );
                  ] );
                      ...
                      `Assoc
                        [
                          ...
                          ( "schema",
                            `Assoc
                              [
                                ("type", `String "integer"); ("default", `Int 0);
                              ] );
                        ] );
                    ( "IncludeInactive",
                      `Assoc
                              ...
                              [
                                ...
                                ( "role",
                                  `Assoc
                                    [
                                      ( "$ref",
                                        `String "#/components/schemas/Role" );
                                    ] );
                                ( "address",
                                  `Assoc
                                    [
                                      ( "$ref",
                                        `String "#/components/schemas/Address"
                                      );
                                    ] );
                              ] );
                        ] );
                      ...
                      `Assoc
                        [
                          ...
                          ( "enum",
                            `List
                              [
                                `String "admin"; `String "user"; `String "guest";
                              ] );
                        ] );
                    ( "Address",
                      `Assoc
  ...
  let schema_with_invalid_reference =
    `Assoc
      [
        ("openapi", `String "3.1.0");
        ( "info",
                              ...
                              [
                                `Assoc
                                  [
                                    ( "$ref",
                                      `String
                                        "#/components/parameters/NonExistentParam"
                                    );
                                  ];
                              ] );
                          ( "responses",
        ...
        ("components", `Assoc [ ("parameters", `Assoc []) ]);
      ]

  let schema_with_content_params =
    `Assoc
      [
        ("openapi", `String "3.1.0");
        ( "info",
                        ...
                        [
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "200",
                                  `Assoc [ ("description", `String "Results") ]
                                );
                              ] );
                        ] );
                  ] );
    ...
    `Assoc
      [
        ...
        ( "info",
          `Assoc
            [
              ("title", `String "All Methods API"); ("version", `String "1.0.0");
            ] );
        ( "paths",
          `Assoc
            [
                        ...
                        [
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "201",
                                  `Assoc [ ("description", `String "Created") ]
                                );
                              ] );
                        ] );
                    ( "put",
                        ...
                        [
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "200",
                                  `Assoc [ ("description", `String "Updated") ]
                                );
                              ] );
                        ] );
                    ( "delete",
                        ...
                        [
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "204",
                                  `Assoc [ ("description", `String "Deleted") ]
                                );
                              ] );
                        ] );
                    ( "patch",
                        ...
                        [
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "200",
                                  `Assoc [ ("description", `String "Patched") ]
                                );
                              ] );
                        ] );
                    ( "head",
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "200",
                                  `Assoc
                                    [ ("description", `String "Headers only") ]
                                );
                              ] );
                        ] );
                    ( "options",
                        ...
                        [
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "200",
                                  `Assoc [ ("description", `String "Options") ]
                                );
                              ] );
                        ] );
                    ( "trace",
                        ...
                        [
                          ...
                          ( "responses",
                            `Assoc
                              [
                                ( "200",
                                  `Assoc [ ("description", `String "Trace") ] );
                              ] );
                        ] );
                  ] );
            ] );
  ...
  let schema_with_external_reference =
    `Assoc
      [
                                                        ...
                                                        ( "obj",
                                                          `Assoc
                                                            [
                                                              ( "$ref",
                                                                `String
                                                                  "http://cyaninc.com/json-schemas/market-v1/product-constraints"
                                                              );
                                                            ] );
                                                      ] );
                                                ] );
...
module TestComplexSchemas = struct
          ...
          if key = "$ref" then
            ...
            | `String ref_str ->
              if String.starts_with ~prefix:"#/components/" ref_str then
                Alcotest.fail
                  (Printf.sprintf "reference '%s' was not rewritten" ref_str)
            | _ -> ()
          else check_no_components_refs value)
        fields
    | `List items -> List.iter check_no_components_refs items
    | _ -> ()
  ...
  let test_complex_schema_list_users_query_param_limit () =
    ...
    let limit_param =
      List.find_opt (fun p -> Parameter.get_name p = "limit") params
    in
    match limit_param with
    | Some param ->
      Alcotest.(check string)
        "param location" "query"
        (Parameter.get_location param);
      let schema = Parameter.get_schema param in
      let default_val =
        Yojson.Safe.Util.member "default" schema |> Yojson.Safe.Util.to_int
      in
  ...
  let test_complex_schema_list_users_query_param_limit_maximum () =
    ...
    | Some param ->
      let schema = Parameter.get_schema param in
      let maximum_val =
        Yojson.Safe.Util.member "maximum" schema |> Yojson.Safe.Util.to_int
      in
  ...
  let test_complex_schema_get_user_path_param_existence () =
    ...
    let user_id_param =
      List.find_opt (fun p -> Parameter.get_name p = "userId") params
    in
  ...
  let test_complex_schema_create_order_request_body_presence () =
    ...
    | Some body ->
      Alcotest.(check bool)
        ...
        (RequestBody.get_required_field body)
  ...
  let test_complex_schema_create_order_request_body_required_fields () =
    ...
    | Some body ->
      ...
      let json_schema = List.assoc "application/json" content_schema in
      let required =
        Yojson.Safe.Util.member "required" json_schema
...
module TestBrokenReferences = struct
  let test_parser_handles_broken_references () =
    let routes =
      parse_openapi_to_http_routes TestData.schema_with_invalid_reference
    in
    Alcotest.(check bool) "routes is list" true (List.length routes >= 0);
    let broken_route =
      List.find_opt
        (fun r ->
          HttpRoute.get_path r = "/broken-ref" && HttpRoute.get_method r = "GET")
        routes
    in
...
module TestContentParameters = struct
  let test_content_param_parameter_name () =
    let routes =
      parse_openapi_to_http_routes TestData.schema_with_content_params
    in
...
module TestHttpMethods = struct
  let test_http_method_presence method_name operation_id =
    let routes =
      parse_openapi_to_http_routes TestData.schema_all_http_methods
    in
    let method_route =
      List.find_opt (fun r -> HttpRoute.get_method r = method_name) routes
    in
...
module TestExternalReferences = struct
  let test_external_reference_raises_clear_error () =
    try
      let _ =
        parse_openapi_to_http_routes TestData.schema_with_external_reference
      in
    ...
    | Invalid_argument error_message ->
      ...
      Alcotest.(check bool)
        ...
        (contains_substring error_message
           "External or non-local reference not supported");
      Alcotest.(check bool)
        "contains reference URL" true
        (contains_substring error_message
           "http://cyaninc.com/json-schemas/market-v1/product-constraints");
      Alcotest.(check bool)
        "contains FastMCP message" true
        (contains_substring error_message
           "FastMCP only supports local schema references")
    | _ -> Alcotest.fail "Expected Invalid_argument exception"
end
...
let () =
  run "OpenAPI Advanced Tests"
    [
      ( "complex_schemas",
        [
          test_case "complex schema route count" `Quick
            TestComplexSchemas.test_complex_schema_route_count;
          test_case "complex schema ref rewriting" `Quick
            TestComplexSchemas.test_complex_schema_ref_rewriting;
          test_case "complex schema list users query param limit" `Quick
            TestComplexSchemas.test_complex_schema_list_users_query_param_limit;
          test_case "complex schema list users query param limit maximum" `Quick
            TestComplexSchemas
            .test_complex_schema_list_users_query_param_limit_maximum;
          test_case "complex schema get user path param existence" `Quick
            TestComplexSchemas.test_complex_schema_get_user_path_param_existence;
          test_case "complex schema get user path param required" `Quick
            TestComplexSchemas.test_complex_schema_get_user_path_param_required;
          test_case "complex schema get user path param format" `Quick
            TestComplexSchemas.test_complex_schema_get_user_path_param_format;
          test_case "complex schema create order request body presence" `Quick
            TestComplexSchemas
            .test_complex_schema_create_order_request_body_presence;
          test_case "complex schema create order request body content type"
            `Quick
            TestComplexSchemas
            .test_complex_schema_create_order_request_body_content_type;
          test_case "complex schema create order request body properties" `Quick
            TestComplexSchemas
            .test_complex_schema_create_order_request_body_properties;
          test_case "complex schema create order request body required fields"
            `Quick
            TestComplexSchemas
            .test_complex_schema_create_order_request_body_required_fields;
        ] );
      ( "broken_references",
        [
          test_case "parser handles broken references" `Quick
            TestBrokenReferences.test_parser_handles_broken_references;
        ] );
      ( "content_parameters",
        [
          test_case "content param parameter name" `Quick
            TestContentParameters.test_content_param_parameter_name;
          test_case "content param parameter location" `Quick
            TestContentParameters.test_content_param_parameter_location;
          test_case "content param schema properties presence" `Quick
            TestContentParameters.test_content_param_schema_properties_presence;
          test_case "content param schema enum presence" `Quick
            TestContentParameters.test_content_param_schema_enum_presence;
        ] );
      ( "http_methods",
        [
          test_case "http get method presence" `Quick
            TestHttpMethods.test_http_get_method_presence;
          test_case "http post method presence" `Quick
            TestHttpMethods.test_http_post_method_presence;
          test_case "http put method presence" `Quick
            TestHttpMethods.test_http_put_method_presence;
          test_case "http delete method presence" `Quick
            TestHttpMethods.test_http_delete_method_presence;
          test_case "http patch method presence" `Quick
            TestHttpMethods.test_http_patch_method_presence;
          test_case "http head method presence" `Quick
            TestHttpMethods.test_http_head_method_presence;
          test_case "http options method presence" `Quick
            TestHttpMethods.test_http_options_method_presence;
          test_case "http trace method presence" `Quick
            TestHttpMethods.test_http_trace_method_presence;
        ] );
      ( "external_references",
        [
          test_case "external reference raises clear error" `Quick
            TestExternalReferences.test_external_reference_raises_clear_error;
        ] );
    ]
