...
module TestData = struct
        ...
        ("get", `Assoc [
          ...
          ("parameters", `List [
            `Assoc [
              ("name", `String "limit");
              ("in", `String "query");
              ("description", `String "How many items to return");
              ("required", `Bool false);
              ("schema", `Assoc [
                ("type", `String "integer");
                ("format", `String "int32");
          ...
          ("responses", `Assoc [
            ("200", `Assoc [("description", `String "A paged array of pets")]);
          ]);
        ]);
        ("post", `Assoc [
          ...
          ("tags", `List [`String "pets"]);
          ("requestBody", `Assoc [("$ref", `String "#/components/requestBodies/PetBody")]);
          ("responses", `Assoc [
            ("201", `Assoc [("description", `String "Null response")]);
          ]);
        ]);
      ]);
      ("/pets/{petId}", `Assoc [
        ("get", `Assoc [
          ...
          ("responses", `Assoc [
            ("200", `Assoc [("description", `String "Information about the pet")]);
          ]);
        ]);
        ("parameters", `List [
          `Assoc [
        ...
        ("PetBody", `Assoc [
          ...
          ("content", `Assoc [
            ("application/json", `Assoc [
              ("schema", `Assoc [("$ref", `String "#/components/schemas/Pet")]);
            ]);
          ]);
        ]);
      ]);
  ...
  let bookstore_schema = `Assoc [
    ("openapi", `String "3.1.0");
    ("info", `Assoc [
      ("title", `String "Book Store API");
      ("version", `String "1.0.0");
    ]);
    ("paths", `Assoc [
      ("/books", `Assoc [
        ("get", `Assoc [
          ...
          ("parameters", `List [
            ...
            `Assoc [
              ...
              ("in", `String "query");
              ("description", `String "Filter by publication date");
              ("required", `Bool false);
              ("schema", `Assoc [
                ("type", `String "string");
                ("format", `String "date");
          ...
          ("responses", `Assoc [
            ("200", `Assoc [("description", `String "A list of books")]);
          ]);
        ]);
        ("post", `Assoc [
          ...
          ("requestBody", `Assoc [
            ...
            ("content", `Assoc [
              ("application/json", `Assoc [
                ("schema", `Assoc [
                  ("type", `String "object");
                  ("required", `List [`String "title"; `String "author"]);
                  ("properties", `Assoc [
                    ("title", `Assoc [("type", `String "string")]);
                    ("author", `Assoc [("type", `String "string")]);
                    ("isbn", `Assoc [("type", `String "string")]);
                    ("published", `Assoc [
                      ("type", `String "string");
                      ("format", `String "date");
                    ]);
                    ("genre", `Assoc [("type", `String "string")]);
                  ]);
                ]);
              ]);
            ]);
          ...
          ("responses", `Assoc [
            ("201", `Assoc [("description", `String "Book created")]);
          ]);
        ]);
      ]);
      ("/books/{isbn}", `Assoc [
        ("get", `Assoc [
          ...
          ("responses", `Assoc [
            ("200", `Assoc [("description", `String "Book details")]);
          ]);
        ]);
        ("delete", `Assoc [
          ...
          ("parameters", `List [
            `Assoc [
              ...
              ("in", `String "path");
              ("required", `Bool true);
              ("description", `String "ISBN of the book to delete");
              ("schema", `Assoc [("type", `String "string")]);
            ];
          ]);
          ("responses", `Assoc [
            ("204", `Assoc [("description", `String "Book deleted")]);
          ]);
        ]);
      ]);
    ]);
    ...
    ("paths", `Assoc [
      ("/items", `Assoc [
        ("get", `Assoc [
          ...
          ("responses", `Assoc [
            ("200", `Assoc [("description", `String "A list of items")]);
          ]);
        ]);
      ]);
    ]);
  ...
  let openapi_30_with_references = `Assoc [
    ("openapi", `String "3.0.0");
    ("info", `Assoc [
      ...
      ("/products", `Assoc [
        ("post", `Assoc [
          ...
          ("requestBody", `Assoc [
            ("content", `Assoc [
              ("application/json", `Assoc [
                ("schema", `Assoc [("$ref", `String "#/components/schemas/Product")]);
              ]);
            ]);
            ("required", `Bool true);
          ]);
      ...
      ("schemas", `Assoc [
        ("Product", `Assoc [
          ...
          ("properties", `Assoc [
            ...
            ("category", `Assoc [("$ref", `String "#/components/schemas/Category")]);
          ]);
        ]);
        ("Category", `Assoc [
          ("type", `String "object");
  ...
  let openapi_31_with_references = `Assoc [
    ("openapi", `String "3.1.0");
    ("info", `Assoc [
...
module TestPetStore = struct
  ...
  let test_petstore_query_parameter () =
    ...
    | Some route ->
        ...
        let type_val = Yojson.Safe.Util.member "type" schema |> Yojson.Safe.Util.to_string in
  ...
  let test_petstore_path_parameter () =
    ...
    | Some route ->
        let params = get_parameters route in
        let path_param = List.find_opt (fun p -> 
          get_name p = "petId"
        ) params in
  ...
  let test_petstore_header_parameters () =
    ...
    | Some route ->
        let params = get_parameters route in
        let header_params = List.filter (fun p -> 
          get_location p = "header"
        ) params in
  ...
  let test_petstore_header_parameter_names () =
    ...
    | Some route ->
        ...
        Alcotest.(check bool) "X-Request-ID in headers" true (List.mem "X-Request-ID" header_names);
        Alcotest.(check bool) "traceId in headers" true (List.mem "traceId" header_names)
    | None -> Alcotest.fail "GET /pets/{petId} route not found"
...
module TestBookStore = struct
  ...
  let test_bookstore_query_parameter_names () =
    ...
    | Some route ->
        ...
        Alcotest.(check bool) "has genre param" true (List.mem "genre" param_names);
        Alcotest.(check bool) "has published_after param" true (List.mem "published_after" param_names);
        Alcotest.(check bool) "has limit param" true (List.mem "limit" param_names)
    | None -> Alcotest.fail "listBooks route not found"
  ...
  let test_version_detection_logic () =
    ...
    List.iter (fun version ->
      ...
      try
        ...
        () (* Success expected *)
      with
      | e -> Alcotest.fail (Printf.sprintf "Failed to parse OpenAPI %s schema: %s" version (Printexc.to_string e))
    ) test_versions
...
module TestReplaceRefWithDefs = struct
  ...
  let test_replace_object_property_ref () =
    ...
    Alcotest.(check bool) "object property ref replacement" true (Yojson.Safe.equal result expected)
  ...
  let test_replace_array_items_ref () =
    ...
    Alcotest.(check bool) "array items ref replacement" true (Yojson.Safe.equal result expected)
  ...
  let test_replace_any_of_refs () =
    ...
    Alcotest.(check bool) "anyOf refs replacement" true (Yojson.Safe.equal result expected)
  ...
  let test_replace_nested_refs () =
    let input = `Assoc [
      ...
      ("properties", `Assoc [
        ("pets", `Assoc [
          ("oneOf", `List [
            `Assoc [("$ref", `String "#/components/schemas/Cat")];
            `Assoc [("$ref", `String "#/components/schemas/Dog")];
          ]);
        ]);
      ]);
    ] in
    ...
    Alcotest.(check bool) "nested refs replacement" true (Yojson.Safe.equal result expected)
end

let () =
  run "OpenAPI Tests" [
    "petstore", [
      test_case "petstore route count" `Quick TestPetStore.test_petstore_route_count;
      test_case "petstore get pets operation id" `Quick TestPetStore.test_petstore_get_pets_operation_id;
      test_case "petstore query parameter" `Quick TestPetStore.test_petstore_query_parameter;
      test_case "petstore path parameter" `Quick TestPetStore.test_petstore_path_parameter;
      test_case "petstore header parameters" `Quick TestPetStore.test_petstore_header_parameters;
      test_case "petstore header parameter names" `Quick TestPetStore.test_petstore_header_parameter_names;
      test_case "petstore request body reference resolution" `Quick TestPetStore.test_petstore_request_body_reference_resolution;
      test_case "tags parsing in petstore routes" `Quick TestPetStore.test_tags_parsing_in_petstore_routes;
    ];
    "bookstore", [
      test_case "bookstore route count" `Quick TestBookStore.test_bookstore_route_count;
      test_case "bookstore query parameter count" `Quick TestBookStore.test_bookstore_query_parameter_count;
      test_case "bookstore query parameter names" `Quick TestBookStore.test_bookstore_query_parameter_names;
      test_case "bookstore delete method" `Quick TestBookStore.test_bookstore_delete_method;
    ];
    "compatibility", [
      test_case "openapi 3.0 compatibility" `Quick TestCompatibility.test_openapi_30_compatibility;
      test_case "openapi 3.1 compatibility" `Quick TestCompatibility.test_openapi_31_compatibility;
      test_case "version detection logic" `Quick TestCompatibility.test_version_detection_logic;
      test_case "openapi 3.0 reference resolution" `Quick TestCompatibility.test_openapi_30_reference_resolution;
      test_case "openapi 3.1 reference resolution" `Quick TestCompatibility.test_openapi_31_reference_resolution;
    ];
    "replace_ref_with_defs", [
      test_case "replace direct ref" `Quick TestReplaceRefWithDefs.test_replace_direct_ref;
      test_case "replace object property ref" `Quick TestReplaceRefWithDefs.test_replace_object_property_ref;
      test_case "replace array items ref" `Quick TestReplaceRefWithDefs.test_replace_array_items_ref;
      test_case "replace any of refs" `Quick TestReplaceRefWithDefs.test_replace_any_of_refs;
      test_case "replace nested refs" `Quick TestReplaceRefWithDefs.test_replace_nested_refs;
    ];
  ] 