...
(** Handle a request *)
val handle_request : t -> (server_request, client_result) request_responder -> unit Lwt.t
...
val handle_logging_message : t -> logging_message_notification_params -> unit Lwt.t
...
val handle_resource_list_changed : t -> resource_list_changed_notification -> unit Lwt.t

(** Handle a prompt list changed notification *)
val handle_prompt_list_changed : t -> prompt_list_changed_notification -> unit Lwt.t

(** Handle a resource updated notification *)
val handle_resource_updated : t -> resource_updated_notification_params -> unit Lwt.t
