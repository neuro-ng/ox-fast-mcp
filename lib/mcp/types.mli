...
val create_text_content : string -> ?annotations:annotations -> ?meta:Yojson.Safe.t -> unit -> content

(** Create an image content block *)
val create_image_content : string -> string -> ?annotations:annotations -> ?meta:Yojson.Safe.t -> unit -> content
...
val create_prompt_message : role:role -> content:content -> prompt_message
