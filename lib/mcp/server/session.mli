...
type t = {
  ...
  incoming_message_stream: ([ `Request of (Mcp.Types.client_request, Mcp.Types.server_result) Shared.Session.Request_responder.t
...
val create :
  read_stream:(Shared.Message.session_message, [> `Msg of string]) result Lwt_stream.t ->
...
val incoming_messages :
  t ->
  ([ `Request of (Mcp.Types.client_request, Mcp.Types.server_result) Shared.Session.Request_responder.t
   | `Notification of Mcp.Types.client_notification
   | `Error of exn ], [`Closed]) Lwt_stream.t 