...
val register_call_tool :
  ...
  'lifespan_context t ->
  (name:string ->
  arguments:(string, Yojson.Safe.t) Base.Map.t ->
  unit ->
  tool_result Lwt.t) ->
  unit
