...
module Logging : sig
  ...
  (** Create logging middleware 
      @param logger Logger instance to use. If None, creates a logger named 'fastmcp.requests'
      @param log_level Log level for messages (default: Info)
      @param include_payloads Whether to include message payloads in logs
      @param max_payload_length Maximum length of payload to log (prevents huge logs)
...
module Structured_logging : sig
  ...
  (** Create structured logging middleware 
      @param logger Logger instance to use. If None, creates a logger named 'fastmcp.structured'
      @param log_level Log level for messages (default: Info)
      @param include_payloads Whether to include message payloads in logs
      @param methods List of methods to log. If None, logs all methods *)
