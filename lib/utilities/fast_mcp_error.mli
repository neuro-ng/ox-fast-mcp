...
val create_fast_mcp_error : ?details:Yojson.Safe.t option -> int -> string -> exn
...
val create_validation_error : ?details:Yojson.Safe.t option -> int -> string -> exn
...
val create_resource_error : ?details:Yojson.Safe.t option -> int -> string -> exn
...
val create_invalid_signature_error : ?details:Yojson.Safe.t option -> int -> string -> exn
...
val create_not_found_error : ?details:Yojson.Safe.t option -> int -> string -> exn
...
val create_disabled_error : ?details:Yojson.Safe.t option -> int -> string -> exn
