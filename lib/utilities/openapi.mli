...
(** Validate an OpenAPI schema
    ...
    @return Ok version if valid (returns the OpenAPI version), Error msg if invalid *)
...
(** Replace OpenAPI $ref with JSON Schema $defs. Also handles external references by replacing them with a placeholder.
...
(** Parse OpenAPI specification into HTTP routes.
